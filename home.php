...
<head>
    ...
    <style>
        .home{
        min-height: 60vh;
        background-image: linear-gradient(rgba(0, 0, 0, .7), rgba(0, 0, 0, .7)), url('images/loja.jpeg');
...
<body>
    ...
    <section class="home">
        <div class="content">
            ...
            <p>Bemvindo ao e-commerce da Yaquene Lima, um local onde você pode fazer a compra de seus produtos.
            </p>
